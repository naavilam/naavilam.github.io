...
Training in algorithms and data structures, theory of computation, compilers,
object-oriented programming, and distributed systems, complemented by
mathematical programming and linear optimization. Software engineering covered
requirements elicitation and specification, use-case analysis, UML models,
operation contracts, the Unified Process, GRASP responsibility assignment,
GoF design patterns, and MVC architecture. Software quality included inspections,
structural testing based on control and data flow, and mutation testing, with
supporting material on Java bytecode analysis using JaBUTi. Database studies
addressed entity--relationship modeling, relational schema design, functional
dependencies, normalization, relational algebra, and SQL. Performance evaluation
combined experimental design, workload characterization, benchmarking,
statistical analysis and confidence intervals with analytical and simulation
models, including queueing networks and Petri nets. Multimedia coursework
connected digital media representation with XML schemas and XSLT transformations
for desktop and mobile presentation.} \\

& \cvwide{\textbf{Computer Architecture:}
Study of digital logic, hardware description, microprocessors, and parallel
computer organization, connecting circuit-level implementation with instruction
execution and system performance. Topics included RISC and CISC instruction
sets, addressing modes, pipelined execution, structural, data, and control
hazards, forwarding, stalls, and branch handling. Superscalar and vector
processing were examined alongside Flynn's taxonomy, SIMD and MIMD systems,
and shared- and distributed-memory architectures. Hardware design used VHDL
and programmable logic concepts. Digital integrated-circuit laboratory work
included synthesis of a UART design with LeonardoSpectrum and AMS
$0.35\,\mu\mathrm{m}$ standard-cell libraries, technology mapping, critical-path
analysis, and area--speed optimization. The design flow extended to Verilog
netlist export, schematic and layout generation in the Mentor environment,
routing, and design-rule checking, linking behavioral descriptions to physical
circuit implementation.} \\

& \cvwide{\textbf{Physics \& Electronics:}
Foundation in classical and quantum mechanics, electromagnetism, and
experimental physics, integrated with circuit analysis, semiconductor devices,
and analog and digital electronics. Device studies covered electronic states
in crystals, intrinsic and doped semiconductors, p--n junctions and depletion
regions, bipolar transistors and the Ebers--Moll model, MOS capacitors, and
MOSFET current--voltage characteristics. Microelectronics connected CMOS
inverter layout and process integration with silicon crystal growth, wafer
preparation, photolithography, oxidation, wet and plasma etching, chemical vapor
deposition, diffusion, ion implantation, and metallization. Signal processing
addressed discrete-time signals and systems, sampling and quantization,
the Z-transform, the discrete Fourier transform, and digital-filter design.
Control studies connected dynamic-system models and feedback with digital
implementation, analog-to-digital and digital-to-analog conversion, and
microprocessor-based control of continuous physical processes.} \\

& \cvwide{\textbf{Communications \& Networks:}
Study of communication systems from electromagnetic propagation and signal
representation to network protocols and multimedia delivery. Communication
theory covered Fourier analysis, power spectral density, amplitude and angular
modulation, noise, sampling, quantization, and bandwidth constraints. Antennas
and optical communications connected radiation and transmission-line concepts
with Maxwell's equations, wave propagation, and dielectric interfaces.
Computer networking addressed layered architectures, data-link protocols,
IP addressing and routing, ICMP, and TCP/UDP transport. Advanced topics included
ATM service classes, SONET/SDH, cluster and storage interconnects, and quality
of service through packet classification, scheduling, traffic policing,
IntServ, and DiffServ. Practical material included Java video streaming with
RTSP session control and RTP packetization over UDP, IEEE 802.11 frame analysis
with Wireshark, and Android exercises involving Bluetooth discovery, Wi-Fi
configuration, and network-traffic statistics.} \\
...
& \cvwide{\textcolor{gray!60}{Requested Amount: US\$5,000.00 in AWS cloud credits}} \\*
& \cvwide{\textcolor{gray!60}{Submitted: September 17, 2026}} \\*
& \cvwide{\textcolor{gray!60}{Status: Submitted --- awaiting review; not yet awarded}} \\
& \cvwide{\cvblank} \\[-0.35em]
& \textbf{Entrepreneurship Workshop (PRPG/USP)} \href{https://prpg.usp.br/pt-br/pae/oficina-empreendedorismo}{[link]} & Spring 2025 \\
...
& \cvwide{\hspace{1.5em}Workshop, August 2026. \href{https://fma.if.usp.br/~avilamrs/index.html\#phenoexp}{[link]}.} \\[0.4em]
...
& \cvwide{\hspace{1.5em}June 2026. \href{https://fma.if.usp.br/~avilamrs/index.html\#retinha-xxxiii}{[link]}.} \\[0.4em]
...
& \cvwide{1. ``Unveiling Quantum Computing: Practical Applications and Future Possibilities.'' Talk at Rio Innovation Week -- AI and Meta World, 2024. \href{https://naavilam.github.io/assets/img/eventos/evento4.png}{[link]}.} \\[0.4em]

& \cvwide{2. ``Quantum Computing. Hands On Quantum Search Algorithms.'' Talk at Open Co, Tech Day, 2022.} \\[0.4em]

& \cvwide{3. ``Shift Your Programming Paradigm to a Quantum Mindset.'' Talk at The Developer's Conference (TDC Business), 2022.\href{https://naavilam.github.io/presentations/20220822_TDC_Business.pdf}{[link]}.} \\[0.4em]
...
& \cvwide{Colégio Galáxia -- Goiânia, Goiás, Brazil} \\
...
& \cvwide{Escola do Parque \href{https://www.escolaparquegoiania.com.br}{[link]} -- Goiânia, Goiás, Brazil} \\
...
& \cvwide{Pontifical Catholic University of Goiás (PUC Goiás) -- Goiânia, Goiás, Brazil} \\
...
& \cvwide{Colégio Logosófico González Pecotche -- Goiânia, Goiás, Brazil} \\
...
& \cvwide{self-awareness, reflection, creativity, and personal expression, making it a particularly} \\
& \cvwide{formative and memorable part of my early education.} \\
& \cvwide{\cvblank} \\[-0.35em]
& \cvwide{\cvblank} \\[-0.35em]

Certificates
& \textcolor{gray!60}{\textbf{HSK 3} -- Proficiency Exam}
\href{https://institutoconfucio.com.br/exame-de-proficiencia/}{[link]}
& \textcolor{gray!60}{18 Oct 2026} \\*
& \cvwide{\textcolor{gray!60}{Instituto Confúcio / São Paulo, SP}} \\
& \cvwide{\cvblank} \\[-0.35em]
& \cvwide{\cvblank} \\[-0.35em]
