...
& \cvwide{1. ``Study of the Effect of Correlated Experimental Uncertainty on Bayesian} \\
& \cvwide{\hspace{1.5em}Inference of Quark--Gluon Plasma Properties.'' Presentation at the XXXIII} \\
...
& \cvwide{2. ``Risk Management and IT Governance in the Adoption of Quantum Computing:} \\
& \cvwide{\hspace{1.5em}A COBIT 5-Based Conceptual Model.'' Presentation at the 5th Congress on} \\
& \cvwide{\hspace{1.5em}Risk Management and ERM, FEA--USP, December 2025.} \\
& \cvwide{\hspace{1.5em}\href{URL_ERM}{[link]}.} \\[0.8em]

& \cvwide{3. ``Exploring the Potential of Quantum Computing in Materials Science.''} \\
