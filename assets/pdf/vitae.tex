...
& \cvwide{The curriculum provided broad interdisciplinary training across four
major areas of computer engineering:} \\

& \cvwide{\textbf{Computer Science \& Software Engineering:}
Algorithms and data structures, theory of computation, compilers,
object-oriented programming and design, software engineering, databases,
distributed systems, performance evaluation, and computer graphics.} \\

& \cvwide{\textbf{Computer Architecture:}
Digital computer organization, processor architecture, microprocessors,
digital systems design, and hardware--software interfacing.} \\

& \cvwide{\textbf{Physics \& Electronics:}
Classical and quantum mechanics, electromagnetism, electromagnetic waves,
experimental physics, electric and electronic circuits, semiconductor physics,
microelectronics, microcontrollers, signal processing, control systems,
and analog and digital integrated circuit design.} \\

& \cvwide{\textbf{Communications \& Networks:}
Communication systems, digital communications, antennas, optical communications,
computer networks, high-performance networks, and mobile networks.} \\
...
Software &
\cvwide{1. MORAES, N. A.; LUZUM, M. W. \textit{hic-bayes}. Python software for Bayesian} \\
...
& \cvwide{2. MORAES, N. A. \textit{Molecular Symmetry}. Web application for parsing molecular} \\
...
& \cvwide{3. MORAES, N. A. \textit{Quantum Battleship}. Quantum computing game that allows} \\
...
& \cvwide{5. MORAES, N. A. \textit{GitHub Release and Milestone CLI}. Command-line tool for} \\
